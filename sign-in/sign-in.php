...
<div class="container"> <!--Div for sign-in form-->
  ...
  <?php 
    ...
    if(isset($_POST['submit'])){ 
      ...
      $verify_query = mysqli_query($con,"SELECT email from users where email='$email'"); // Check if it exists in the database 
  ...
  <main class="form-signin w-100 m-auto">
    <form action="sign-in.php" method="post">
      <a href="/index.html">
        <img class="mb-4" src="https://i.ibb.co/wSRbVFr/Island-School-Logo.png" alt="Homepage" width="10%">
      </a>
      <h1 class="h3 mb-3 fw-normal">Please sign in</h1>

      <div class="form-floating">
        Email: <input type="email" class="form-control" id="floatingInput" placeholder="name@online.island.edu.hk">
