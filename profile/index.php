<?php 
  ...
  // Retrieve the user id of the seller's page (this page)
  $seller = $_GET['seller']; 

  $sql_seller = "SELECT `user_id` FROM users WHERE username = ?";
  $stmt_seller = mysqli_prepare($connection, $sql_seller);
  mysqli_stmt_bind_param($stmt_seller, "s", $seller);
  mysqli_stmt_execute($stmt_seller);
  $result_seller = mysqli_stmt_get_result($stmt_seller);

  if ($result_seller->num_rows == 1) {
  ...
  mysqli_free_result($result_seller);
  ...
  <html lang="en" data-bs-theme="auto">
    ...
    <main>
      ...
      <h5 class="alert alert-primary">
        <?php echo "Here are " . $seller . "'s listings!"; ?>
      </h5>
        ...
        <div class="container"> <!-- Products section -->
          ...
          <?php
            ...
            mysqli_stmt_bind_param($stmt, "s", $seller_id); // Bind the seller_id 
            ...
            if ($result && mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    // For convenience and enhancing user experience. 
                      echo '<a href="/ISDepository/listing-details/index.php?listing_id=' . $row['listing_id'] . '" data-toggle="tooltip" style="display: inline" title="View listing">';
                      ...
                      echo '<div class="card" style="width: 18rem">'; 
                          ...
                          echo '<div class="card-body">'; 
                            echo '<a href="/ISDepository/listing-details/index.php?listing_id=' . $row['listing_id'] . '" class="btn btn-primary" data-toggle="tooltip">Details</a>'; // View details 
