...
/*       $uploaded_images = array();
      ...
      $input_tags = $_POST["tags"]; 
        if(empty($input_tags)){
            ...
            $tags = array_unique($input_tags); // Remove duplicate entries
        }
      ...
      if(empty($title_err) && empty($img_err) && empty($desc_err) && empty($price_err) && empty($condition_err)){ 
        ...
        $sql = "INSERT INTO listings (listing_id, seller_id, title, description, price, condition_id, created_at) VALUES (UUID(), ?, ?, ?, ?, ?, current_timestamp())"; // Since 'condition' is a reserved keyword in mysql, I have changed it to 'condition_id' for clarity 
        ...
        if($stmt = mysqli_prepare($connection, $sql)){ 
          ...
          if(mysqli_stmt_execute($stmt)){ 
            ...
            foreach ($tags as $tag_id) {
              $sql_tags = "INSERT INTO listing_tags (listing_id, tag_id) VALUES (?, ?)";
              if ($stmt_tags = mysqli_prepare($connection, $sql_tags)) {
                mysqli_stmt_bind_param($stmt_tags, "si", $listing_id, $tag_id);
...
<!DOCTYPE html>
  ...
  <head>
    ...
    <title>ISDepository · Create Listing</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p style="font-style: italic">Please fill in the details below to create your listing!</p>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <select name="tags[]" multiple id="tags" class="js-example-basic-multiple" style="width:100%" placeholder="Please enter relevant tags...">
                            <?php
