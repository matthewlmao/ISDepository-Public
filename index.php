...
<html lang="en" data-bs-theme="auto">
  ...
  <main>
    ...
    <div class="container sample-products"> <!-- Products section -->
      ...
      <div class="flex-container" style="justify-content: center"> <!-- big container -->
        
        <h4 style="font-style: italic" class="alert alert-danger">Please <a href="sign-in" class="orange-link">log in</a> to view listings!</h4>
